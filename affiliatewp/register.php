...
<form id="affwp-register-form" class="affwp-form" action="" method="post">
	...
	<fieldset>
		...
		<?php if ( ! is_user_logged_in() ) : ?>
			...
			$key = 'affiliate_country'; 
			$single = true; 
			
			$aff_country = get_user_meta( $user_id, $key, $single ); ?>
			<p>
				<label for="affwp-country"><?php _e( 'Two Letter Country Code', 'affiliate-wp' ); ?><span style=color:red>*</span></label>
				<input id="affwp-country" class="required" type="text" name="affwp_country" value="<?php echo $aff_country; ?>" title="<?php esc_attr_e( 'Country', 'affiliate-wp' ); ?>" />
			</p>
