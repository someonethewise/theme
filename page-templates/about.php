...
<section class="container-fluid section-grey pv-xs-2 pv-lg-5 affiliatewp-team">
	<div id="mascot">
		<img alt="Alf" src="<?php echo get_stylesheet_directory_uri() . '/images/svgs/about-alf.svg'; ?>">
	</div>
    <div class="wrapper">
		...
		<div class="grid row">
			...
			<div class="grid-item col-xs-12 col-sm-6 col-md-4 mb-xs-2 mb-sm-0">
				<div class="grid-item-inner">
					...
					<div class="about-details">
						<h3 class="grid-item-title">Pippin Williamson</h3>
			...
			<div class="grid-item col-xs-12 col-sm-6 col-md-4 mb-xs-2 mb-sm-0">
				<div class="grid-item-inner">
					...
					<div class="about-details">
						<h3 class="grid-item-title">Andrew Munro</h3>
			...
			<div class="grid-item col-xs-12 col-sm-6 col-md-4 mb-xs-2 mb-sm-0">
				<div class="grid-item-inner">
					...
					<div class="about-details">
						<h3 class="grid-item-title">Lisa Gibson</h3>
			...
			<div class="grid-item col-xs-12 col-sm-6 col-md-4 mb-xs-2 mb-sm-0">
				<div class="grid-item-inner">
					...
					<div class="about-details">
						<h3 class="grid-item-title">Michael Beil</h3>
			...
			<div class="grid-item col-xs-12 col-sm-6 col-md-4 mb-xs-2 mb-sm-0">
				<div class="grid-item-inner">
					...
					<div class="about-details">
						<h3 class="grid-item-title">Drew Jaynes</h3>
